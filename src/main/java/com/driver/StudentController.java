...
public class StudentController {
    ...
    public ResponseEntity<String> addStudentTeacherPair(@RequestParam("name1") String student, @RequestParam("name2") String teacher){
    ...
    public ResponseEntity<String> deleteTeacherByName(@RequestParam("name") String teacher){
        studentService.removeTeacherByName(teacher);
